          ...
          <div className="hidden lg:flex items-center gap-4">
             <div className="glass-panel p-4 rounded-2xl border-white/[0.05] bg-white/[0.01] flex items-center gap-4 max-w-sm group hover:bg-white/[0.03] transition-all cursor-help">
                <div className="w-16 h-16 rounded-xl overflow-hidden flex-shrink-0 border border-white/10">
                   <img src="https://gen.pollinations.ai/prompt/cyberpunk%20cityscape%20neon%20reflections?width=100&height=100&model=flux" alt="Example" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
                <div>
             ...
             <div className="glass-panel p-4 rounded-2xl border-white/[0.05] bg-white/[0.01] flex items-center gap-4 max-w-sm group hover:bg-white/[0.03] transition-all cursor-help">
                <div className="w-16 h-16 rounded-xl overflow-hidden flex-shrink-0 border border-white/10">
                   <img src="https://gen.pollinations.ai/prompt/ancient%20forest%20foggy%20mystical?width=100&height=100&model=flux" alt="Example" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
                <div>
